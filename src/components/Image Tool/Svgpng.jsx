            ...
            <div className="flex flex-col sm:flex-row gap-3">
              {fileType === "svg" && (
                <button
                  ...
                  className={`bg-gradient-to-r from-indigo-300 to-purple-200 text-[#14143B] flex-1 py-2 rounded-lg font-semibold ${imageSrc ? "" : "cursor-not-allowed opacity-50"
                    }`}
                  disabled={!imageSrc}
                >
                  Convert SVG to PNG
              ...
              <button
                ...
                className={`bg-[#273D58] text-white px-5 py-2 rounded-xl shadow-md cursor-pointer" ${pngDataUrl ? "" : "cursor-not-allowed opacity-50"
                  }`}
                disabled={!pngDataUrl}
              >
                Download
