          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="relative">
              ...
              <select
                ...
                className="block w-full px-3 py-2 border border-gray-500 rounded-lg bg-white text-gray-900 focus:ring-indigo-500 focus:border-indigo-500"
              >
                {[1, 2, 3, 4, 5, 6].map((num) => (
            ...
            <button
              ...
              className={`cursor-pointer bg-[#273D58]  border border-white text-white  flex items-center gap-2 px-6 py-3 rounded-lg  transition-colors `}
            >
              <FaCopy size={14} />
